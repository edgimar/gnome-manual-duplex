...
if True:
    from gi.repository import GObject, Gtk, PanelApplet, GdkPixbuf, Gdk
...
def showAboutDialog(self, *arguments, **keywords):
    ...
    about.set_version("v0.38")
    about.set_copyright("Copyright 2009 Rick Richardson. All Rights Reserved.")
